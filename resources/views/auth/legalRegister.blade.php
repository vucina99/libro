    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/dodajkorisnika">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="maticni_broj" type="text" class="form-control @error('maticni_broj') is-invalid @enderror" name="maticni_broj" value="{{ old('maticni_broj') }}" required autocomplete="maticni_broj" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Grad') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fix" type="number" class="form-control @error('fix') is-invalid @enderror" name="fix" value="{{ old('fix') }}" required autocomplete="fix">

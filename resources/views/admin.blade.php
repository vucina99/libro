...
<main class="samodole">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <h3 class="text-center">DODAVANJE MALOPRODAJA</h3><hr><br>
                <form action="/dodavanjemaloprodaje" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if( Session::has( 'dodavanjemalo' ))
                    <div class="alert alert-dark alert-dismissible fade show " role="alert">
                       <strong><i class="fas fa-check"></i></strong>  {{ Session::get( 'dodavanjemalo' ) }}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                 <select name="podkategorija" id="podkategorija" class="form-control @error('podkategorija') is-invalid @enderror" value="{{ old('podkategorija') }}"  autocomplete="podkategorija" autofocus >
    ...
    <input type="number" value="1" name="vrsta_id" hidden="">
    <br><br>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-12">
            <h3 class="text-center">BRISANJE MALOPRODAJA</h3><hr><br>
            <input id="myInput" type="text" class="form-control"  placeholder="PRETRAGA" >
            <br><br>
            @if( Session::has( 'deletemalo' ))
            <div class="alert alert-dark alert-dismissible fade show " role="alert">
               <strong><i class="fas fa-check"></i></strong>  {{ Session::get( 'deletemalo' ) }}
               <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
              </button>
          </div>
          ...
          <tbody id="myTable">
             ...
             <tr>
              ...
              <td>
                <form action="/brisanjeproizvodamalo/{{$p->id}}" method="POST">
                  @csrf
                  @method("delete")
